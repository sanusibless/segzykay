...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
  	 @if(session('success'))<div class="top-50 alert alert-success mx-auto px-4" id="alert" style="position:absolute; z-index: 550000; left: 30vw">{{ session('success') }}</div>@endif
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{ url('assets/img/logo.png') }}" alt="">
        <span class="d-none d-lg-block">SegzyKay</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <img src="{{ auth()->user()->image != null ? url('storage/'. auth()->user()->image ) : url('img/pngwing.com.png')  }}" alt="{{ auth()->user()->full_name }} Profile Image" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.participants') }}">
